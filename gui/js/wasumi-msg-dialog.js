var originalWasu = '<div id="wasu-msg" class="dislogMsg"><div id="wasu-msg-contain"><div class="closeMsg" style="width: 100%; height: 100%;"></div><div id="wasu-msg-content"><div class="w-title"><span id="wasu-msg-title">This is the Title!</span><button class="closeMsg" id="btn-closeMsg">X</button></div><div class="w-container"><div id="wasu-msg-icon"></div><div id="wasu-msg-message">Post Message will be here!</div></div><div class="w-buttonArea"><button id="btn-msg-close" class="closeMsg">Close</button><button id="btn-msg-cancel" class="closeMsg">Cancel</button><button id="btn-msg-okay" class="closeMsg">Okay</button><button id="btn-msg-no" class="closeMsg">No</button><button id="btn-msg-yes" class="closeMsg">Yes</button><button id="btn-msg-tryAgain" class="closeMsg">Try again</button></div></div></div></div>',
    $waMsg = $(originalWasu);
        ...
        if(button) {
            if(button.addButton) {
                $.each(button.addButton, function( index, value ) {
                    allButton.prepend('<button id="btn-msg-' + value.namespace + '" class="closeMsg">' + value.text + '</button>') 
                });
            }
